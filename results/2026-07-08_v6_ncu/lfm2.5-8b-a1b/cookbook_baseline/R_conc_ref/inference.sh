...
exec /home/t-jialianggu/.conda/envs/sglang-dev/bin/python -m sglang.bench_one_batch \
  ...
  --profile-filename-prefix /home/t-jialianggu/work/MOEresearch/results/2026-07-08_v6_ncu/lfm2.5-8b-a1b/cookbook_baseline/R_conc_ref/sglang_bench \
  --result-filename /home/t-jialianggu/work/MOEresearch/results/2026-07-08_v6_ncu/lfm2.5-8b-a1b/cookbook_baseline/R_conc_ref/bench_one_batch_result.jsonl \
  --run-name ncu_v6 \
