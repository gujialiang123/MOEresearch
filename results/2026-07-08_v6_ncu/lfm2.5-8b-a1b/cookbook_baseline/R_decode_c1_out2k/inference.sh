...
exec /home/t-jialianggu/.conda/envs/sglang-dev/bin/python -m sglang.bench_one_batch \
  ...
  --profile-filename-prefix /home/t-jialianggu/work/EndtoEnd-auto-optimization/results/2026-07-08_v6_ncu/lfm2.5-8b-a1b/cookbook_baseline/R_decode_c1_out2k/sglang_bench \
  --result-filename /home/t-jialianggu/work/EndtoEnd-auto-optimization/results/2026-07-08_v6_ncu/lfm2.5-8b-a1b/cookbook_baseline/R_decode_c1_out2k/bench_one_batch_result.jsonl \
  --run-name ncu_v6 \
  --mem-fraction-static 0.85 --max-running-requests 32 --chunked-prefill-size -1 --schedule-policy lpm --moe-runner-backend auto
