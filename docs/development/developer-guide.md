# Developer Guide — SGLang End-to-End Optimization Agent

> 🇬🇧 English first · 🇨🇳 [跳转中文版 (jump to Chinese)](#-中文版)
>
> **📖 This is the long-form developer / design document.** For a short
> repo intro + quickstart, see the top-level [`README.md`](../../README.md)
> first.
>
> Some directory-tree diagrams in this file are historical snapshots taken
> before the 2026-05-28 docs reshuffle (e.g. they still show top-level
> `SKILLS.md`, `LOGS.md`, `STATUS.md`). The canonical, up-to-date layout
> is in `README.md`. The diagrams here are kept so the rest of the
> narrative stays consistent — read them as "concepts", not as filesystem
> ground truth.
...
- Architecture overview (bilingual): [`docs/architecture/two-stage-overview.md`](../architecture/two-stage-overview.md)
- Problem package schema: [`docs/problem-package/schema.md`](../problem-package/schema.md)
- Idea pool (bidirectional channel): [`docs/idea-pool/schema.md`](../idea-pool/schema.md)
...
See [`SKILLS.md`](../skills/README.md) for the design principles + how to add a
...
- [`SKILLS.md`](../skills/README.md) — skills design principles & how to add new ones
- [`LOGS.md`](./log-layout.md) — log layout
...
- 架构总览（双语）：[`docs/architecture/two-stage-overview.md`](../architecture/two-stage-overview.md)
- 题目包 schema：[`docs/problem-package/schema.md`](../problem-package/schema.md)
- Idea 池（双向通道）：[`docs/idea-pool/schema.md`](../idea-pool/schema.md)
...
设计原则和"如何加新 skill"见 [`SKILLS.md`](../skills/README.md)。当前清单：
...
- [`SKILLS.md`](../skills/README.md) — skills 设计原则 + 怎么加新 skill
- [`LOGS.md`](./log-layout.md) — log 布局
